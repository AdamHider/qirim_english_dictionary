...
function init(){
    ...
    include 'fillDiyarMorphology_participle_noun.php';
    /*include 'fillDiyarMorphology_participle_pronoun.php';
    include 'fillDiyarMorphology_participle_adverbs.php';
    include 'fillDiyarMorphology_participle_adjectives.php';*/
    //include 'fillDiyarMorphology_moods_negative.php';
    $parts_of_speech = [
        'NOUN' => [$noun]
        /*'COMP' => [$adberb_comparative]*/
    ];
...
function finalComposing($result, $tense, $pts_name, $word){
    if($pts_name == 'NOUN' || $pts_name == 'NUMR'  || $pts_name == 'NUMR'  ){
        return composeNounMorphology($result, $tense, $pts_name, $word);
    }
    if($pts_name == 'COMP'){
...
function composeNounMorphology($result, $tense, $pts_name, $word){
    $result_list = [];
    ...
    foreach($result as $key => $form){
        ...
        $word_object['tense'] = '';
        $word_object['mood'] = 'poss';
        $word_object['case'] = '';
        $word_object['tense_mark'] = 'possession_plur';
        ...
        switch($tense){
            case 'isafet':
                ...
                break;
            case 'nominative_possession':
                $word_object['part_of_speech'] = $pts_name;
                $word_object['case'] = 'nomn';
                $word_object['possession_plurality'] = 'sing';
                $word_object['tense_mark'] = $tense;
                $result_list[] = $word_object;
                break;
            case 'genitive_possession':
                $word_object['part_of_speech'] = $pts_name;
            ...
            case 'exodive_possession':
                ...
                $result_list[] = $word_object;
                break;
            case 'nominative_plural_possession':
                $word_object['part_of_speech'] = $pts_name;
                $word_object['case'] = 'nomn';
                $word_object['possession_plurality'] = 'plur';
                $word_object['tense_mark'] = $tense;
                $result_list[] = $word_object;
                break;
            case 'genitive_plural_possession':
                $word_object['part_of_speech'] = $pts_name;
                $word_object['case'] = 'gent';
                $word_object['possession_plurality'] = 'plur';
                $word_object['tense_mark'] = $tense;
            ...
            case 'dative_plural_possession':
                ...
                $result_list[] = $word_object;
                break;
            case 'accusative_plural_possession':
                $word_object['part_of_speech'] = $pts_name;
                $word_object['case'] = 'accs';
                $word_object['possession_plurality'] = 'plur';
                $word_object['tense_mark'] = $tense;
                $result_list[] = $word_object;
                break;
            case 'placive_plural_possession':
                $word_object['part_of_speech'] = $pts_name;
                $word_object['case'] = 'loct';
                $word_object['possession_plurality'] = 'plur';
                $word_object['tense_mark'] = $tense;
                $result_list[] = $word_object;
                break;
            case 'exodive_plural_possession':
                $word_object['part_of_speech'] = $pts_name;
                $word_object['case'] = 'exod';
                $word_object['possession_plurality'] = 'plur';
                $word_object['tense_mark'] = $tense;
