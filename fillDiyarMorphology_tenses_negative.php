...
$tenses_negative = [
    ...
    'past_continuous_negative' => [
     ...
     'past_remote_negative' => [
        'group' => 'tense',
        'template' => 'personilized',
        'hard' => [
            'sonorous' => [
                'single_syllable'=>[
                    ['mağ*an ed*im', 'mağ*an ed*iñ', 'mağ*an ed*i' ],
                    ['mağ*an ed*ik', 'mağ*an *ediñiz', 'mağ*an ed*iler' ]
                ],
                'multi_syllable'=>[
                    ['mağ*an ed*im', 'mağ*an ed*iñ', 'mağ*an ed*i' ],
                    ['mağ*an ed*ik', 'mağ*an *ediñiz', 'mağ*an ed*iler' ]
        ...
        'soft' => [
            'sonorous' => [
                'single_syllable'=>[
                    ['meg*en ed*im', 'meg*en ed*iñ', 'meg*en ed*i' ],
                    ['meg*en ed*ik', 'meg*en *ediñiz', 'meg*en ed*iler' ]
                ],
                'multi_syllable'=>[
                    ['meg*en ed*im', 'meg*en ed*iñ', 'meg*en ed*i' ],
                    ['meg*en ed*ik', 'meg*en *ediñiz', 'meg*en ed*iler' ]
    ...
    'future_simple_negative' => [
        ...
        'template' => 'personilized',
         'hard' => [
            'sonorous' => [
                'single_syllable'=>[
                    ['maycağım', 'maycaqsıñ', 'maycaq' ],
                    ['maycaqmız', 'maycaqsıñız', 'maycağılar' ]
                ],
                'multi_syllable'=>[
                    ['maycağım', 'maycaqsıñ', 'maycaq' ],
                    ['maycaqmız', 'maycaqsıñız', 'maycağılar' ]
        ...
        'soft' => [
            'sonorous' => [
                'single_syllable'=>[
                    ['meycegim', 'meyceksiñ', 'meycek' ],
                    ['meycekmiz', 'meyceksiñiz', 'meycekler' ]
                ],
                'multi_syllable'=>[
                    ['meycegim', 'meyceksiñ', 'meycek' ],
                    ['meycekmiz', 'meyceksiñiz', 'meycekler' ]
